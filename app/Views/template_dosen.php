    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
      <div class="container">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a href="/home" class="nav-link">Beranda Dosen</a>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                ...
                <li><a href="/jadwal" class="dropdown-item">Jadwal Mengajar </a></li>
                <li><a href="absensi" class="dropdown-item">Absensi Mahasiswa </a></li>
              </ul>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                <li><a href="/krs" class="dropdown-item">Nilai Mahasiswa </a></li>
                <li><a href="/krs" class="dropdown-item">Kartu Rencana Studi </a></li>
                <li><a href="/krs" class="dropdown-item">Kartu Hasil Studi </a></li>
              </ul>
            </li>
        </div>
        <!-- Right navbar links -->
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              ...
              <a href="#" class="dropdown-item">
                <i class="fas fa-envelope mr-2"></i> Panduan Siakad Dosen
              </a>
            </div>
          </li>
          <!-- Notifications Dropdown Menu -->
          ...
          <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
              <i class="fa fa-th-large"></i> Dosen Pengajar
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              <div class="container">
                <img src="<?= base_url() ?>/template/dist/img/user8-128x128.jpg" class="img-circle" alt="userimage">
                <p> Muhammad Ridho <br>
                  <small> Dosen Pengajar sejak januari. 2015</small>
                </p>
              </div>
              <div class="dropdown-divider"></div>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Beranda Dosen</a></li>
